...
trait BasicConjugatedForm extends HasInitialForm with HasConjugationType with HasTense with OptionallyHasPerson with HasNumber with HasEndingHint with HasReflection with HasAspect {
